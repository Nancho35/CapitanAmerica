...
class AliadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aliado" do
    assert_difference('Aliado.count') do
      post aliados_url, params: { aliado: { descripcion: @aliado.descripcion, nombre: @aliado.nombre } }
    end
  ...
  test "should update aliado" do
    patch aliado_url(@aliado), params: { aliado: { descripcion: @aliado.descripcion, nombre: @aliado.nombre } }
